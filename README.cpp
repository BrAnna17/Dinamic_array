...
Creation of dynamic array using pointers*
 Брагина Анна, семенар 6, задача 10.
 Есть два массива, массив ключей и массив значений. Также есть третий массив в котором попарно
 хранятся указатели на соответствующие эллементы этих двух массивов. Необходимо организовать сортировку пар
 в третьем массиве по возрастанию ключей, а также добавление ноой пары ключ-значение ко всей коллекции*/
